...
- A second message continues the same Session after the first response.
- Esc during streaming returns to the message input with “Turn interrupted”; sending another message then succeeds without the interrupted message appearing in model history.
